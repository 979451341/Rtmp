...
Java_com_wangheart_ffmpegdemo_ffmpeg_FFmpegHandle_setCallback(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_wangheart_ffmpegdemo_ffmpeg_FFmpegHandle_pushRtmpFile(JNIEnv *env, jobject instance,
                                                             jstring path_,jstring outUrl_) {
